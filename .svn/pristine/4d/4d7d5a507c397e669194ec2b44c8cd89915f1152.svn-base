...
namespace ToolboxLibrary
{
	...
	public class ToolboxXmlManager
	{
		...
		private Type[] windowsFormsToolTypes = new Type[] {
          ...
          typeof(AppControls.AppTextBox),
           typeof(AppControls.AppLabel),
		...
		private ToolboxTabCollection PopulateToolboxTabs()
		{
			...
			string[] tabNames = { Strings.WindowsForms
                                    //Strings.ApptitudeControls
                                    //Strings.Data,
                                    //Strings.UserControls
                                };
		...
		private void PopulateToolboxItems(ToolboxTab toolboxTab)
		{
			...
			switch (toolboxTab.Name)
			{
				case Strings.WindowsForms:
					...
					break;
				case Strings.ApptitudeControls:
		...
		private class Strings
		{
			...
			public const string WindowsForms = "Controls";
			public const string ApptitudeControls = "AppTitude Controls";
